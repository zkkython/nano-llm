...
class Trainer:
    ...
    def _load_snapshot(self, snapshot_path):
        ...
        # state_dict = {f"module.{k}": v for k, v in state_dict.items()}  # 添加前缀
    ...
    def _save_snapshot(self, epoch):
        print(f'是否是分布式模型{isinstance(self.model, DDP)}')
        snapshot = {
...
# python single_node_multi_gpus.py --total_epochs 32 --save_every 10 --batch_size 32